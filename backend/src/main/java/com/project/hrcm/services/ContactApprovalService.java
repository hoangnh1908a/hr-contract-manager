...
public class ContactApprovalService {
  ...
  public static Specification<ContractApproval> filterBy(
      ContractApprovalRequest contractApprovalRequest) {
  ...
  public Page<ContractApproval> getContactApprovals(
  ...
  public void deleteContactApproval(Integer id, Locale locale) {
    ...
    auditLogService.saveAuditLog(
        Constants.DELETE, TABLE_NAME, id, Utils.gson.toJson(contractApproval.get()), "");
  }
}
