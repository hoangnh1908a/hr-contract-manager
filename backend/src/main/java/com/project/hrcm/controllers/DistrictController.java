...
public class DistrictController {
  ...
  public ResponseEntity<Page<District>> getDistricts(
      @RequestParam(required = false) DistrictRequest district, Pageable pageable) {
  ...
  @PostMapping("/get")
  @PreAuthorize("hasAuthority('" + Constants.ROLE_ADMIN + "')")
  public ResponseEntity<District> getDistrictById(@Valid @RequestBody String id, Locale locale) {
    return new ResponseEntity<>(
        service.getDistrictById(Integer.valueOf(id), locale), HttpStatus.OK);
  }
  ...
  @PostMapping("/delete")
  @PreAuthorize("hasAuthority('" + Constants.ROLE_ADMIN + "')")
  public ResponseEntity<String> deleteDistrict(@Valid @RequestBody String id, Locale locale) {
