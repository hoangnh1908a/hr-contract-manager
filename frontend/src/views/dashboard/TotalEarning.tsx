...
const data: DataType[] = [
  {
    ...
    title: 'Phòng ban A',
    amount: '1000',
    subtitle: 'Nhân viên vào làm việc',
...
const TotalEarning = () => {
  return (
    <Card>
      <CardHeader title='Phòng ban nhận nhiều nhân viên vào làm việc'></CardHeader>
      <CardContent className='flex flex-col gap-11 md:mbs-2.5'>
        <div>
          ...
          <Typography>Tổng số hợp đồng thành công</Typography>
        </div>
